                ...
                <div class="col-lg-4">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img src="/foodimage/{{ $item->image}}" alt="Chef #1">
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        <form id="contact" enctype="multipart/form-data" method="POST" action="{{route('reservation','App\Http\Controllers\HomeController@reservation')}}" >
                        @csrf
                            <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <input value="number-guests" type="number" name="guest" id="number-guests">
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <input value="time" name="time" id="time" type='time'>
